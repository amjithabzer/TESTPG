...
<form id="payment_form" action="{{route('secure.payment.confirm')}}" method="post">
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
            ...
            <span>reference_number:</span>            <input type="text" name="reference_number" value="AMJ{{date('YmdHis')}}"><br/>
            <span><b>auth_trans_ref_no</b>:</span>    <input type="text" name="auth_trans_ref_no" value="AMJ{{date('YmdHi')}}"><br/>
            <span>amount:</span>                      <input type="text" name="amount" value="5"><br/>
            <span>currency:</span>                    <input type="text" name="currency" value="AED"><br/>
            <span>locale:</span>                      <input type="text" name="locale" value="en"> (en-us, th-th, ja-jp)<br/>
            <span>merchant_descriptor:</span>         <input type="text" name="merchant_descriptor" value="Amjith K">
    </fieldset>
    <p>
    <fieldset>
        ...
        The name of each unsigned field should be included in the unsigned_field_names.
            ...
            <span>bill_to_forename:</span>            <input type="text" name="bill_to_forename" value="Amjith"><br/>
            <span>bill_to_surname:</span>             <input type="text" name="bill_to_surname" value="K"><br/>
            <span>bill_to_email:</span>               <input type="text" name="bill_to_email" value="amjith.k@abzer.com"><br/>
            <span>bill_to_phone:</span>               <input type="text" name="bill_to_phone" value="+919400828969"><br/>
            <span>bill_to_address_line1:</span>       <input type="text" name="bill_to_address_line1" value="Kottayi House" maxlength="60"><br/>
            <span>bill_to_address_line2:</span>       <input type="text" name="bill_to_address_line2" value="Peravoor" maxlength="60"><br/>
            <span>bill_to_address_city:</span>        <input type="text" name="bill_to_address_city" value="kannur"><br/>
            <span>bill_to_address_state:</span>       <input type="text" name="bill_to_address_state" value="Kerala"><br/>
            <span>bill_to_address_country:</span>     <input type="text" name="bill_to_address_country" value="IN"><br/>
            <span>bill_to_address_postal_code:</span> <input type="text" name="bill_to_address_postal_code" value="670673"><br/>
    ...
    <input type="hidden" name="item_1_unit_price" value="5.00">
